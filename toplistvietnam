...
// label.
// ---------------------------------------------------
// Author: Top List Viet Nam
// Url: http://www.toplistvietnam.com/
// ---------------------------------------------------
...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Top List Viet Nam có ' + postTitle.length + ' Bài Viết <br/></span>'; }
   else {
